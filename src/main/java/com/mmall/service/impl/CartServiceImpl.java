...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse<CartVo> list(Integer userId){//查询
    ...
    private CartVo getCartVoLimit(Integer userId){  //在CartVo下边组装cart里面的productVo,有限制的返回CartVo
